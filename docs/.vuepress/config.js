module.exports = {
  title: 'Vue Storefront 2 for medusa',
  base: '/',
  description: 'Documentation for the medusa connector for Vue Storefront 2',
  head: [
  ...
  themeConfig: {
    repo: 'https://github.com/vuestorefront/medusa',
    editLinks: true,
    docsDir: 'docs',
    docsBranch: 'develop',
    ...
    nav: [
      ...
      // { text: 'Demo', link: '' },
      { text: 'GitHub', link: 'https://github.com/vuestorefront/medusa'},
      { text: 'Roadmap', link: 'https://github.com/vuestorefront/medusa'}
    ],
    sidebar: [
      {
        title: 'Essentials',
